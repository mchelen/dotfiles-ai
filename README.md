...
| [`repo-config.md`](defaults/repo-config.md) | Repo settings as code, never clicked through the UI — the Settings app first because it is easier to set up, Terraform when you need its reach *(GitHub-specific)* |
