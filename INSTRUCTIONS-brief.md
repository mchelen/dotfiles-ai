...
- Every project keeps a `CHANGELOG.md`, written for readers rather than generated from the log.
...
- Lead with the answer, flag a bad idea before acting, and disclose what you skipped or left failing.
